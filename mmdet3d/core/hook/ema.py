...
class ModelEMA:
    ...
    def __init__(self, model, decay=0.9999, updates=0, exp_factor=2000):
        """
        Args:
        ...
        self.decay = lambda x: decay * (1 - math.exp(-x / exp_factor))
...
class MEGVIIEMAHook(Hook):
    ...
    def __init__(self, init_updates=0, decay=0.9990, resume=None, exp_factor=2000):
        super().__init__()
